...
const Review = ({ review }) => {
  ...
  return (
    <div className={`space-y-7 max-w-5xl mx-auto `}>
      <div className="bg-indigo-50 p-6 rounded-xl relative shadow-sm ">
        <div className="mb-2">
          <PiQuotes className="text-5xl text-gray-500 rotate-180 " />
        </div>
        <p className="text-gray-500 mb-2">
         {description}
        </p>
        <span className="absolute -bottom-6 left-6 text-indigo-50">
